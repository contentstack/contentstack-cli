...
**Note**: This package is deprecated and no longer maintained. Security updates are not supported. We recommend avoiding its use. We recommend you to check out our latest [CLI documentation](https://www.contentstack.com/docs/developers/cli) for performing content management activities.
